...
def map_labels(original_label, original_min=1.283, original_max=4.123, new_min=0.0001, new_max=0.9999):
    """
    ...
    new_min (float, optional): The minimum value of the new range. Defaults to -2.5.
    new_max (float, optional): The maximum value of the new range. Defaults to 3.0.
...
def prepare_fluorescence_samples(dataset_path, task_token, max_length, max_samples, random_seed, logging):
